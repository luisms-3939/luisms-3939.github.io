...
<!-- Skills Philosophy -->
<div class="content-section fade-in">
  <h2>My Approach to Data</h2>
  
  <div class="philosophy-content">
    <div class="philosophy-item">
      <h3><iconify-icon icon="healthicons:register-book-outline" width="32" style="color:#4cc9a6"></iconify-icon> Story-Driven Data</h3>
    ...
    <div class="philosophy-item">
      <h3><iconify-icon icon="oui:question-in-circle" width="32" style="color:#4cc9a6"></iconify-icon> Question Everything</h3>
    ...
    <div class="philosophy-item">
      <h3><iconify-icon icon="icon-park-twotone:six-circular-connection" width="32" style="color:#4cc9a6"></iconify-icon> Holistic View</h3>
...
<div class="cta-section fade-in">
  ...
  <p>
    I'm always interested in new challenges, collaborations, and opportunities to solve complex problems with data.
  </p>
...
.timeline-dot {
  ...
  border-radius: 50%;
  box-shadow: 0 0 0 4px rgba(76, 201, 166, 0.2);
}
